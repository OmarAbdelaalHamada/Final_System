...
add wave -noupdate /sys_tb/DUT/UART_inst/u_UART_TX/fsm_inst/current_state
add wave -noupdate /sys_tb/DUT/UART_inst/u_UART_TX/fsm_inst/next_state
add wave -noupdate /sys_tb/DUT/UART_inst/u_UART_TX/fsm_inst/delayed_current_state
...
add wave -noupdate /sys_tb/DUT/Sys_crtl_inst/ALU_OUT_reg
add wave -noupdate /sys_tb/DUT/rinc
add wave -noupdate /sys_tb/DUT/FIFO_inst/fifo_rd_inst/rq2_wptr
add wave -noupdate /sys_tb/DUT/FIFO_inst/fifo_rd_inst/rptr
add wave -noupdate /sys_tb/DUT/FIFO_inst/fifo_rd_inst/rempty
add wave -noupdate /sys_tb/DUT/FIFO_inst/winc
add wave -noupdate /sys_tb/DUT/WR_INC
add wave -noupdate /sys_tb/DUT/UART_inst/u_UART_TX/fsm_inst/current_state
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {29155000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {22021757 ps}
